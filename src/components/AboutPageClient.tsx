            ...
            <div>
              <div className="sticky top-40 flex flex-col items-start gap-8">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[#ff5c00]" />
      ...
      <section className="pb-16 md:pb-32 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-black rounded-[32px] md:rounded-[48px] p-8 md:p-20 text-center relative overflow-hidden group">
            <div className="absolute inset-0 bg-[#ff5c00]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <div className="relative z-10 flex flex-col items-center gap-6 md:gap-8">
              <h2 className="text-3xl md:text-6xl font-bold tracking-tight text-white leading-tight">
                Let's build your <br />
                <span className="text-[#ff5c00]">next growth engine.</span>
              </h2>
              <Link 
                href="/book" 
                className="flex items-center gap-4 bg-white text-black px-8 py-4 md:px-10 md:py-5 rounded-full font-bold text-lg md:text-xl hover:bg-[#ff5c00] hover:text-white transition-all transform hover:scale-105 shadow-xl shadow-black/20"
              >
