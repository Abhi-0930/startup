...
import { CheckCircle2, Target, Zap, Clock, ClipboardList, Lightbulb, UserCheck } from "lucide-react";
      ...
      <div className="container mx-auto max-w-7xl relative">
        ...
        <div className="flex flex-col items-center mb-12 px-6">
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-black tracking-tight leading-[1.1]">
              Book your <span className="italic">session.</span>
            </h1>
            <p className="text-md text-zinc-600 max-w-xl mx-auto leading-relaxed font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-16 px-4">
          <div className="space-y-6">
            <h3 className="text-[10px] font-bold text-black uppercase tracking-[0.2em] text-center md:text-left">What we'll achieve Together</h3>
            <div className="space-y-6">
              {takeaways.map((item, idx) => (
                ...
                >
                  ...
                  <div className="space-y-0.5">
                    <h4 className="font-bold text-zinc-900 text-md">{item.title}</h4>
          ...
          <div className="p-8 rounded-[32px] bg-zinc-50 border border-zinc-100 flex flex-col justify-center relative overflow-hidden">
            ...
            <h3 className="text-[10px] font-bold text-black uppercase tracking-[0.2em] mb-6 relative z-10">Prerequisites</h3>
