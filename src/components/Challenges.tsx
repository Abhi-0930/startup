...
const challengesData = [
  {
    id: "01",
    challenge: "Your brand is lost in the crowd.",
    solution: "We build unique, premium designs that instantly grab attention and separate you from the competition.",
  ...
  {
    id: "02",
    challenge: "Your website looks nice, but brings zero sales.",
    solution: "We stop focusing on just looks, and design websites strictly built to turn visitors into paying customers.",
    imageSrc: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200&auto=format&fit=crop",
    videoSrc: "https://videos.pexels.com/video-files/3252251/3252251-hd_1920_1080_24fps.mp4"
  },
  {
    id: "03",
    challenge: "People don't trust you enough to buy.",
    solution: "We build professional, authoritative websites that instantly prove your credibility and establish trust.",
  ...
  {
    id: "04",
    challenge: "You waste too much time trying to do it yourself.",
    solution: "We handle all the heavy digital execution for you, allowing you to focus entirely on running your business.",
    ...
    >
      ...
      <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end pointer-events-none">
        ...
        <div className={`transform transition-transform duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] ${isActive ? '-translate-y-2' : 'translate-y-0'}`}>
          <span className="text-white/60 text-[12px] md:text-[13px] font-bold tracking-wider uppercase block mb-3 drop-shadow-md">
            Challenge {item.id}
          </span>
          <h3 className="text-white text-[22px] md:text-[28px] font-semibold leading-tight drop-shadow-md max-w-lg">
            {item.challenge}
          </h3>
        </div>
        ...
        <div className={`grid transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] ${isActive ? 'grid-rows-[1fr] opacity-100 mt-4 md:mt-5' : 'grid-rows-[0fr] opacity-0 mt-0'}`}>
          <div className="overflow-hidden flex flex-col gap-2 md:gap-3">
            ...
            <p className="text-white/90 text-[14px] md:text-[16px] leading-relaxed max-w-xl">
              {item.solution}
            </p>
          </div>
        </div>
...
export default function Challenges() {
  return (
    <section className="pt-8 pb-24 md:pt-12 md:pb-32 max-w-[1400px] mx-auto px-4 md:px-8">
      ...
      {/* Grid of Interactive Media Cards (Updated to 2x2) */}
