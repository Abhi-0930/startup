  ...
  return (
    <main className="min-h-screen bg-[#fcfcfc] selection:bg-black selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
        <div className="container mx-auto max-w-7xl relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-[10vw] md:text-[8vw] font-black leading-[0.9] tracking-tighter text-[#09090b] uppercase">
              Partners for <br />
              <span className="text-zinc-300">growth.</span>
            </h1>
            <p className="mt-12 text-xl md:text-2xl text-zinc-500 font-medium max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-24 md:py-32 px-6 bg-white border-y border-zinc-100">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div className="divide-y divide-zinc-100 mt-20 lg:mt-0">
              {milestones.map((milestone, index) => (
                <motion.div
                  ...
                  className="py-12 flex flex-col md:flex-row items-baseline gap-8 md:gap-16 group cursor-default"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            {comparison.map((side) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className={`p-8 md:p-12 rounded-[48px] border ${
                  side.isPrimary 
      ...
      <section className="pb-24 md:pb-32 px-6">
        <div className="container mx-auto max-w-7xl">
          <div className="bg-black rounded-[48px] p-12 md:p-20 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
              ...
              <Link 
                href="/career" 
                className="group/btn flex items-center bg-white rounded-full pl-8 pr-3 py-3 gap-6 transition-all hover:scale-105 shadow-xl shadow-black/20"
              >
                <span className="text-black font-bold text-xl uppercase tracking-tight">Join Us</span>
                <div className="w-14 h-14 rounded-full border border-black/5 flex items-center justify-center transition-transform group-hover/btn:rotate-[-45deg]">
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
            {founders.map((founder, index) => (
              ...
              >
                {/* Portrait Card */}
                <div className="relative w-full aspect-[4/5] rounded-[48px] md:rounded-[64px] overflow-hidden mb-8 border-[8px] border-white shadow-2xl shadow-black/10 transition-transform duration-500 group-hover:scale-[1.02]">
                  <Image
                    src={founder.image}
                    alt={founder.name}
                    fill
                  ...
                  <div className="absolute top-8 right-8 px-5 py-2.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white font-bold text-[13px] uppercase tracking-widest translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                    {founder.role}
                  </div>
                </div>
                ...
                <div className="text-center space-y-4">
                  <div className="space-y-1">
                    <h3 className="text-3xl md:text-4xl font-bold text-zinc-900">{founder.name}</h3>
                    <p className="text-zinc-400 font-bold uppercase tracking-widest text-[13px]">{founder.role}</p>
                  </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-black rounded-[48px] p-12 md:p-20 text-center relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center gap-8">
              ...
              <Link 
                href="/book" 
                className="flex items-center gap-4 bg-white text-black px-10 py-5 rounded-full font-bold text-xl hover:bg-[#FF4D4D] hover:text-white transition-all transform hover:scale-105 shadow-xl shadow-black/20"
              >
